...
<title><?=$PageQry->meta_title?></title>

<meta name="description" content="<?=$PageQry->meta_description?>">

<meta name="keywords" content="<?=$PageQry->meta_keywords?>">
        ...
        <div class="content">
          ...
          <div class="section-title mb0 headline text-left ">
            ...
            <div class="layer-1-3">
              ...
              <h2>Pro<span>file</span></h2>

            </div>

          </div>

          <p><?=$PageQry->sub_title?></p>
      ...
      <div class="col-md-6 research-read-more2">
        ...
        <div class="section-title mb0 headline text-left ">
          ...
          <div class="layer-1-3">
            ...
            <h2>OUR <span> Profile</span></h2>

          </div>

        </div>

       <?=$PageQry->short_description?>
