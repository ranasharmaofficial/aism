...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-6" style="margin-top:-1.4em;padding: 0">

				<img src="<?=base_url('assets/cork/img/register.jpg')?>" style="border-radius: 0;width: 100%;height: 100%;">
			...
			<div class="col-md-6">
				...
				<div class="form-register-group registerform">
						...
						<div class="tab-content">
							...
							<div id="signup">   
								...
								<div class="section-title mb20 headline text-center ">
									...
									<h2>Sign Up <span> for Free</span></h2>
								...
								<form action="<?=base_url('register/insert')?>" method="post">
									...
									<div class="top-row">
										...
										<div class="field-wrap">
											...
											<input type="text" name="last_name" required="" placeholder="Last Name*" autocomplete="off">
