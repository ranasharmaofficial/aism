...
<body>
							...
							<div class="col-12">
								...
								<div class="card">          	
									...
									<div class="card-body text-center">
										...
										<form method="POST" action="<?=base_url('apply-now/insert')?>" class="pt-2">
											...
											<div class="row">
												...
												<div class="col-6">
													...
													<input type="text" class="form-control" placeholder="Course" name="course" value="<?=$this->session->flashdata('s_course')?>">
                                       <input type="hidden" class="form-control" placeholder="Course" name="course_id" value="<?=$this->session->flashdata('s_course_id')?>">

												</div>

												<div class="col-6">

													<input type="text" class="form-control" placeholder="Duration" name="duration" value="<?=$this->session->flashdata('s_duration')?>">

												</div>

												<div class="col-6">

													<input type="text" class="form-control" placeholder="Eligibility" name="eligibility" value="<?=$this->session->flashdata('s_eligibility')?>">

												</div>

												<div class="col-6">

													<input type="text" class="form-control" placeholder="Course Fee" name="course_fee" value="<?=$this->session->flashdata('s_course_fee')?>">
   ...
   <option value="Zimbabwe">Zimbabwe</option>
											...
											<button type="submit" class="btn btn-block text-light py-1" style="background-color: #f18f3b">Submit</button>	
