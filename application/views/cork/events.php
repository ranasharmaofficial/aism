        ...
        <div class="content">
          ...
          <div class="section-title mb0 headline text-left">
            ...
            <div class="layer-1-3">
              ...
              <h2><span><?=$PageQry->page_title?></span></h2>
...
<div class="section-event">
 ...
 <div class="container">
  ...
  <div class="row">
    ...
    <?php foreach($EventsQry as $EventsRow){?>
   ...
   <div class="col-md-4">
    ...
    <div class="event-group">
     ...
     <div class="event-sec1">
      ...
      <img src="<?=base_url('assets/images/events')?>/<?=$EventsRow->image?>" alt="event">

      <div class="ddmmyyyy">

        <?php

                $originalDate = $EventsRow->date;
    ...
    <div class="event-sec2">
      ...
      <p><span><?=$EventsRow->title?></span></p>

     <?=$EventsRow->short_description?>

    </div>

    <a href="<?=base_url('event')?>/<?=$EventsRow->slug?>/<?=$EventsRow->id?>">READ MORE</a>
