              ...
              <div class="widget-header">
                <div class="row">
                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>Add Subject Information</h4>
                  </div>
                </div>
              </div>
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/student_zone/insert_subj')?>" name="form" enctype="multipart/form-data">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
						<select name="class_id" required class="form-control">
							...
							<?php foreach($ClassQry as $clsRows){?>
								<option value="<?=$clsRows->id;?>"><?=$clsRows->class_name;?></option>
							<?php }?>
						</select>
                    </div>
                  </div>
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" required class="form-control" name="subject_name">
                    </div>
                  </div>
				<div class="form-group row">
                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Subject Code</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="number" required class="form-control" name="subject_code">
                    </div>
                  </div>
