              ...
              <div class="widget-header">
                <div class="row">
                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>Edit Lession Information</h4>
                  </div>
                </div>
              </div>
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/lession/update')?>" name="form" enctype="multipart/form-data">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <select class="form-control" name="ccid" id="ccid">
                        ...
                        <?php foreach($CoursesQry as $CoursesRow){?>
                         <option value="<?=$CoursesRow->id?>" <?php if($CoursesRow->id==$PageQry->cid){echo 'selected';}?>><?=$CoursesRow->name?></option>
                        <?php }?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      ...
                      <br>
                      <img src="<?=base_url('assets/images/lession')?>/<?=$PageQry->image?>" height="100" width="100">
                      <?php }?>
                    </div>
                  </div>
