    ...
    <div class="layout-px-spacing">
      ...
      <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">         
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12"><a href="<?=base_url('juggler/city/add')?>" class="btn btn-secondary mb-2 pull_right">Add City</a></div>
            ...
            <div class="table-responsive mb-4 mt-4">           
              ...
              <table id="zero-config" class="table table-hover" style="width:100%">
                ...
                <tbody>
				 ...
				 foreach($CityQry as $page){

				$StateRow = $this->db->where(['id'=>$page->state_id,'status'=>1])->get('tbl_state')->row();
...
<script type="text/javascript">
    ...
    function delete_page(id){
       var r=confirm("Do you want to delete this?")
        if (r==true)
          window.location = url+"juggler/city/delete/"+id;
        else
          return false;
    } 
</script>
