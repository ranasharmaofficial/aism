          ...
          <div id="flHorizontalForm" class="col-lg-12 layout-spacing layout-top-spacing">
            <div class="statbox widget box box-shadow">
              ...
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/student_zone/update_class')?>" name="form" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?=$PageQry->id?>">
                  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" required name="name" value="<?=$PageQry->class_name?>">
                    </div>
                  </div>
                
                  <div class="form-group row">
                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Enrollment Fee Amount</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="number" required class="form-control" value="<?=$PageQry->enrollment_amount?>" name="amount">
                    </div>
                  </div>
