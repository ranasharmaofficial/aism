    ...
    <div class="layout-px-spacing">
      <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">         
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12"><a href="<?=base_url('juggler/student_zone/add_class')?>" class="btn btn-secondary mb-2 pull_right">Add Class</a></div>
...
{
  window.location.href = "<?=base_url('juggler/student_zone/delete_class/')?>"+id;
}
</script>
</body>
</html>
