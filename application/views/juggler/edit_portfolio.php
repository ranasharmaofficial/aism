              ...
              <div class="widget-header">
                <div class="row">
                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>Edit Portfolio Information</h4>
                  </div>
                </div>
              </div>
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/portfolio/update')?>" name="form" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?=$PageQry->id?>">
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" name="slug" value="<?=$PageQry->name?>">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      ...
                      <br>
                      <img src="<?=base_url('assets/images/portfolio')?>/<?=$PageQry->image?>" height="100" width="100">
                      <?php }?>
                    </div>
                  </div>
