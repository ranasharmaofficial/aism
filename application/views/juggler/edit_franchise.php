                           ...
                           <div class="widget-header">
                              <div class="row">
                                 <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Edit Franchise Information</h4>
                                 </div>
                              </div>
                           </div>
                           <div class="widget-content widget-content-area">
                              <form method="post" action="<?=base_url('juggler/franchises/update')?>" name="form" enctype="multipart/form-data">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-sm-10">
                                       <input type="text" required class="form-control" value="<?=$PageQry->franchise_name;?>" name="name">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">School Name</label>
                                    <div class="col-xl-9 col-lg-9 col-sm-10">
                                       <input type="text" required class="form-control" value="<?=$PageQry->franchise_school;?>" name="school_name">
                                    </div>
                                 </div>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-sm-10">
                                      <select name="state_id" id="state_id" class="form-control">
                                        ...
                                        <option <?php if($StateRow->id==$PageQry->state_id){ echo "selected"; } ?>  value="<?=$StateRow->id?>">
                                            <?=$StateRow->name?>
                                        </option>
                                      <?php }?>
                                      </select>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-sm-10">
                                       <input type="tel" required class="form-control" value="<?=$PageQry->franchise_phone;?>" name="phone">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Email</label>
                                    <div class="col-xl-9 col-lg-9 col-sm-10">
                                       <input type="email" required class="form-control" autocomplete="off" value="<?=$PageQry->franchise_email;?>" name="email">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Address</label>
                                    <div class="col-xl-9 col-lg-9 col-sm-10">
                                       <textarea class="form-control" rows="1" name="address"><?=$PageQry->franchise_address;?></textarea>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Password</label>
                                    <div class="col-xl-9 col-lg-9 col-sm-10">
                                       <input type="password" id="myInput" required autocomplete="off" class="form-control" value="<?=md5($PageQry->password);?>" name="password">
