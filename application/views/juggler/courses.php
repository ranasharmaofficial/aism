    ...
    <div class="layout-px-spacing">
      <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12"><a href="<?=base_url('juggler/courses/add')?>" class="btn btn-secondary mb-2 pull_right">Add Course</a></div>
...
<script>
    ...
    function delete_page(id){
       var r=confirm("Do you want to delete this?")
        if (r==true)
          window.location = url+"juggler/courses/delete/"+id;
        else
          return false;
    }
</script>
