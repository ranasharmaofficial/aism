              ...
              <div class="widget-header">
                <div class="row">
                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>Edit Enquiry Information</h4>
                  </div>
                </div>
              </div>
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/enquiry/update')?>" name="form">
                <input type="hidden" name="id" value="<?=$PageQry->id?>">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" name="subject" value="<?=$PageQry->subject?>">
                    </div>
                  </div>
                   <div class="form-group row">
                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Message</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="message" class="form-control" id="message"><?=$PageQry->message?></textarea>
                    </div>
                  </div>
                   <div class="form-group row">
                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Notes</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="notes" class="form-control" id="notes"><?=$PageQry->notes?></textarea>
                    </div>
                  </div>
