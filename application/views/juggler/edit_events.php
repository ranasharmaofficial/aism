          ...
          <div id="flHorizontalForm" class="col-lg-12 layout-spacing layout-top-spacing">
            <div class="statbox widget box box-shadow">
              ...
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/events/update')?>" name="form" enctype="multipart/form-data">
                 <input type="hidden" name="id" value="<?=$PageQry->id?>">
                 
                  <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Title</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" name="title" value="<?=$PageQry->title?>">
                    </div>
                  </div>
                   <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Slug</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" name="post_slug" value="<?=$PageQry->slug?>">
                    </div>
                  </div>
                    <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Sub Title</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" name="sub_title" value="<?=$PageQry->sub_title?>">
                    </div>
                  </div>
                    <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Location</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" name="location" value="<?=$PageQry->location?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Meta Title</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="meta_title" class="form-control"><?=$PageQry->meta_title?></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Meta Keyword</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="meta_keywords" class="form-control"><?=$PageQry->meta_keywords?></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Meta Description</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="meta_description" class="form-control"><?=$PageQry->meta_description?></textarea>
                    </div>
                  </div>
                   <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Short Description</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="short_description" id="short_description" class="form-control"><?=$PageQry->short_description?></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Description</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="description" id="description" class="form-control"><?=$PageQry->description?></textarea>
                    </div>
                  </div>
                 
                  <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Date</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" name="date" id="date2" value="<?=$PageQry->date?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      ...
                      <br>
                      <img src="<?=base_url('assets/images/events')?>/<?=$PageQry->image?>" height="100" width="100">
                      <?php }?>
                    </div>
                  </div>
