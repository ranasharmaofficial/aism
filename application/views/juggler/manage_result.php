    ...
    <div class="layout-px-spacing">
      <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">         
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12"><a href="<?=base_url('juggler/student_zone/upload_results')?>" class="btn btn-secondary mb-2 pull_right">Upload Result</a></div>
                ...
                <tbody>
				 ...
				 ?>
                  <tr>
                    <td><?=$s?></td>
                    <td>
					<?php if(!empty($PageRow->file)){?>
						<a target="_blank" href="<?=base_url($PageRow->file);?>">Download</a>
					<?php }?>
					</td>
                    <td><?=$PageRow->created_date?></td>                   
                    <td>
                        <a href="<?=base_url('juggler/student_zone/upload_results')?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                            </svg>
                        </a>
                        <a href="javascript:void(0);" onClick="confirm('Do you want to delete this?') && deleteItem(<?=$PageRow->id?>)">
...
{
  window.location.href = "<?=base_url('juggler/student_zone/delete_result/')?>"+id;
}
</script>
</body>
</html>
