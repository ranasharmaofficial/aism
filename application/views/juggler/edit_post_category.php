              ...
              <div class="widget-header">
                <div class="row">
                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>Edit Post Category Information</h4>
                  </div>
                </div>
              </div>
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/post/update_category')?>" name="form" enctype="multipart/form-data">                  
                <input type="hidden" name="id" value="<?=$PostQry->id?>">
                  <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Name</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" name="category_name" value="<?=$PostQry->category_name?>">
                    </div>
                  </div>
                   <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Slug</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" name="category_slug" value="<?=$PostQry->category_slug?>">
                    </div>
                  </div>                  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="category_description" id="category_description" class="form-control"><?=$PostQry->category_description?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      ...
                      <?php if($PostQry->category_image!=''){?>
                      <br>
                      <img src="<?=base_url('assets/images/post-category')?>/<?=$PostQry->category_image?>" height="100" width="100">
                      <?php }?>
                    </div>
                  </div>
