              ...
              <div class="widget-header">
                <div class="row">
                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>Add Page Information</h4>
                  </div>
                </div>
              </div>
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/pages/insert')?>" name="form">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="page_sub_title" class="form-control"></textarea>
                    </div>
                  </div>
                   <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="hPassword" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Page Meta Keyword</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <textarea name="page_meta_keywords" class="form-control"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
