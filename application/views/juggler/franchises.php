    ...
    <div class="layout-px-spacing">
      <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">         
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12"><a href="<?=base_url('juggler/franchises/add')?>" class="btn btn-secondary mb-2 pull_right">Add Franchise</a></div>
              ...
              <table id="zero-config" class="table table-hover" style="width:100%">
                ...
                <tbody>
				 ...
				 foreach($PageQry as $PageRow){ ?>
                  <tr>
                    <td><?=$s?></td>
                    <td><?=$PageRow->franchise_name;?></td>
                    <td><?=$PageRow->franchise_school;?></td>
                    <td><?=$PageRow->franchise_unique_id;?></td>
                    <td><?=$PageRow->franchise_email;?></td>                                   
                    <!--<td><?=$PageRow->franchise_phone;?></td> -->                  
                    <td>
						<a href="<?=base_url('juggler/franchises/add_pay')?>/<?=$PageRow->id?>"><div class="btn bg-confirmed btn-xs no-margin">Pay</div>
						<a href="<?=base_url('juggler/franchises/view_pay')?>/<?=$PageRow->id?>" target="_blank"><div class="btn bg-confirmed btn-xs no-margin">PayView</div>
						<a href="<?=base_url('juggler/franchises/edit')?>/<?=$PageRow->id?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></a> <a href="javascript:void(0);" onClick="confirm('Do you want to delete this?') && deleteItem(<?=$PageRow->id?>)"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 table-cancel"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a>
					</td>
                  </tr>
                 <?php $s++; } ?>
                </tbody>
...
{
  window.location.href = "<?=base_url('juggler/franchises/delete/')?>"+id;
}
</script>
</body>
</html>
