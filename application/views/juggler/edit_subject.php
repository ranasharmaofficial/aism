          ...
          <div id="flHorizontalForm" class="col-lg-12 layout-spacing layout-top-spacing">
            <div class="statbox widget box box-shadow">
              ...
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/student_zone/update_subj')?>" name="form" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?=$PageQry->id?>">
                  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
						<select name="class_id" required class="form-control">
							...
							<?php foreach($ClassQry as $clsRows){?>
								<option value="<?=$clsRows->id;?>"<?php if($PageQry->class_id==$clsRows->id){echo "selected";}?>><?=$clsRows->class_name;?></option>
							<?php }?>
						</select>
                    </div>
                  </div>
				  ...
				  <div class="form-group row">
                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Subject Name</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="text" class="form-control" required name="subject_name" value="<?=$PageQry->subject_name;?>">
                    </div>
                  </div>
                
                  <div class="form-group row">
                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Subject Code</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="number" required class="form-control" value="<?=$PageQry->subject_code;?>" name="subject_code">
                    </div>
                  </div>
