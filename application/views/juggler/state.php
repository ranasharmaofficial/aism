               ...
               <div class="row layout-top-spacing" id="cancel-row">
                  <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                     <div class="widget-content widget-content-area br-6">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12"><a href="<?=base_url('juggler/state/add')?>" class="btn btn-secondary mb-2 pull_right">Add State</a></div>
                           ...
                           <table id="zero-config" class="table table-hover" style="width:100%">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><?=$page->modified?></td>
                                    <td>
                                       <a href="<?=base_url('juggler/state/edit')?>/<?=$page->id?>">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit table-edit">
                                             <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                             <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                          </svg>
                                       </a>
                                       <a href="javascript:void(0);" onclick="delete_page(<?php echo $page->id;?>);">
      ...
      <script type="text/javascript">
         ...
         function delete_page(id){
            var r=confirm("Do you want to delete this?")
             if (r==true)
               window.location = url+"juggler/state/delete/"+id;
             else
               return false;
         } 
      </script>
