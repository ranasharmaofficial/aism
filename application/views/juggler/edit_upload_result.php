          ...
          <div id="flHorizontalForm" class="col-lg-12 layout-spacing layout-top-spacing">
            <div class="statbox widget box box-shadow">
              ...
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/student_zone/update_result')?>" name="form" enctype="multipart/form-data">
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="number" required class="form-control" value="<?=$PageQry->enrollment_no;?>" name="enrollment">
                    </div>
                  </div>
				  <div class="form-group row">
                    <label for="hEmail" class="col-xl-3 col-sm-3 col-sm-2 col-form-label">Result pdf :-</label>
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      <input type="file" class="form-control" name="image">
                      <input type="hidden" value="<?=$PageQry->result_file;?>"  name="Old_image">
					<?php 
						if(!empty($PageQry->result_file)){?>
						<img src="<?=base_url('assets/cork/images/pdf.png');?>" height="80" width="80">
					<?php }?>	
				   </div>
                  </div>
