                ...
                <tbody>
                 <?php 
                  ...
                  <tr>
                    ...
                    <td><?=$PageRow->enrollment_no;?></td>
                    <td><?=$PageRow->center_code;?></td>
                    <td><?=$PageRow->session;?></td>                   
                    <td><?=$PageRow->school_name;?></td>                                    
                    <td>
						<a href="<?=base_url('juggler/student_zone/enroll_details')?>/<?=$PageRow->id?>" ><div class="btn bg-confirmed btn-xs no-margin">View</div></a>
...
{
  window.location.href = "<?=base_url('juggler/student_zone/delete_enroll/')?>"+id;
}
</script>
</body>
</html>
