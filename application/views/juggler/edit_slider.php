          ...
          <div id="flHorizontalForm" class="col-lg-12 layout-spacing layout-top-spacing">
            <div class="statbox widget box box-shadow">
              ...
              <div class="widget-content widget-content-area">
                <form method="post" action="<?=base_url('juggler/slider/update')?>" name="form" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?=$PageQry->id?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-10">
                      ...
                      <br>
                      <img src="<?=base_url('assets/images/slider')?>/<?=$PageQry->image?>" height="100" width="100">
                      <?php }?>
                    </div>
                  </div>
                   <div class="form-group row">
