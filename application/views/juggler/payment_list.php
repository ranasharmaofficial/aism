...
$fra_id = $this->uri->segment(4);
$FraNmQ = $this->db->where('id',$fra_id)->get('tbl_franchise')->row();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Franchise Payment List</title>
    ...
    <div class="layout-px-spacing">
      <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">         
		  ...
		  <h4>Hi, <?=$FraNmQ->franchise_name;?> Your Payment Info</h4>
            ...
            <div class="table-responsive mb-4 mt-4">           
              <table id="zero-config" class="table table-hover" style="width:100%">
                ...
                <tbody>
                 <?php 
				 //print_r($PayQry);die();
				 $PageQry = $this->db->where('franchaise_id',$fra_id)->get('tbl_payment')->result();
				  $s=1;
				 foreach($PageQry as $PRow){
				 ?>
                  <tr>
                    <td><?=$s?></td>
                    <td><?=$PRow->id;?></td>
                    <td><?=$PRow->debited_by;?></td>
                    <td><?=$PRow->credit_amount;?></td>
                    <td><?=$PRow->debit_amount;?></td>
                    <td><?=$PRow->created_date;?></td>                   
                    <td><?=$PRow->status;?></td>                   
                    <td><a href="javascript:void(0);" onClick="confirm('Do you want to delete this?') && deleteItem(<?=$PRow->id;?>)"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 table-cancel"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a></td>
                  </tr>
                 <?php $s++; } ?>
                </tbody>
                <tfoot>
...
{
  window.location.href = "<?=base_url('juggler/franchises/delete_payment/')?>"+id;
}
</script>
</body>
</html>
